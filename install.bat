...
curl https://raw.githubusercontent.com/sanychonline/iis-logs-cleanup/refs/heads/main/archive-logs.ps1 -o C:\Users\Default\AppData\Local\Microsoft\Windows\PowerShell\archive-logs.ps1
